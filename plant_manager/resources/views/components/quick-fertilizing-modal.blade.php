  ...
  <div class="bg-white rounded-lg shadow-lg p-6 w-96">
    ...
    <form id="quickFertilizingFormFromModal" action="{{ route('plants.fertilizing-history.store', $plant) }}" method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="date" id="quickFertilizingDateFromModal" name="fertilizing_date" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-green-500">
      </div>
      <div class="mb-3">
