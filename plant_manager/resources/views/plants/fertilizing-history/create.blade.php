...
@section('content')
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <x-history-form :plant="$plant" type="fertilizing" />
  </div>
@endsection
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <title>Nouvelle fertilisation - {{ $plant->name }}</title>
...
<div class="container mx-auto px-4 py-6 max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('plants.fertilizing-history.store', $plant) }}" method="POST">
            @csrf
