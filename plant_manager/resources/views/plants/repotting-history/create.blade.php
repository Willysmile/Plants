...
<head>
  ...
  <title>Nouveau rempotage - {{ $plant->name }}</title>
...
<div class="container mx-auto px-4 py-6 max-w-2xl">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('plants.repotting-history.store', $plant) }}" method="POST">
            @csrf
